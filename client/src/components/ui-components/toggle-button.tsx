...
// probably should just use a component library
// but I wanted to make one myself as a learning exercise
...
export default function ToggleButton({
    ...
    return (
        <button type="button" className={internalButtonClass} onClick={() => onChange(!buttonState)}>
            {buttonLabel}
        </button>
    );
}
